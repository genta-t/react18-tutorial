...
const NavComp = ({ currentUserId, setCurrentUserId } : TypeCurrentUserId) => {
  const {
    isLoading,
    error,
    data: employees,
  ...
  const onChangeUser = (e: React.ChangeEvent<HTMLSelectElement>) => setCurrentUserId(e.target.value)
